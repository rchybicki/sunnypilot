...
def get_lead(v_ego, ready, clusters, lead_msg, vision_v_ego, low_speed_override=True):
  ...
  if cluster is not None:
    ...
    lead_dict = Cluster().get_RadarState_from_vision(lead_msg, v_ego, vision_v_ego)
...
class RadarD():
  def __init__(self, radar_ts, delay=0):
    ...
    vision_v_ego = 0. #initialize vision ego based on model
