...
class LongitudinalMpc:
  ...
  def update(self, radarstate, v_cruise, x, v, a, j, personality=log.LongitudinalPersonality.standard):
    ...
    if self.mode == 'acc':
      ...
      acc_following_distance = desired_follow_distance(v_cruise_clipped, lead_xv_0[:,1], self.desired_TF)
      print(f"acc_following_distance: {acc_following_distance} meters")
      ...
      blended_following_distance = desired_follow_distance(self.x_sol[:,1], lead_xv_0[:,1], self.desired_TF)
      print(f"blended_following_distance: {blended_following_distance} meters")
