...
A_CRUISE_MAX_VAL_GAP4 = [ 0.5, 0.6, 0.7, 1.0, 1.0, 0.9, 0.8,  0.5,  0.4,  0.3,  0.2]
A_CRUISE_MAX_VAL_GAP3 = [ 0.7, 0.9, 1.0, 1.3, 1.3, 1.2, 1.0,  0.8,  0.6,  0.5,  0.3]
A_CRUISE_MAX_VAL_GAP2 = [ 0.9, 1.1, 1.2, 1.4, 1.3, 1.2, 1.0,  0.8,  0.6,  0.5,  0.3]
A_CRUISE_MAX_VAL_GAP1 = [ 1.1, 1.3, 1.4, 1.5, 1.3, 1.2, 1.0,  0.8,  0.6,  0.5,  0.3]
...
class LongitudinalPlanner:
  ...
  def cruise_solutions(self, enabled, v_ego, a_ego, v_cruise, sm):
    ...
    if self.speed_limit_controller.is_active:
      ...
      if self.params.get_bool("SpeedLimitPercOffset"):
