...
def create_lkas11(packer, frame, car_fingerprint, apply_steer, steer_req,
  ...
  if car_fingerprint in (CAR.SONATA, CAR.PALISADE, CAR.KIA_NIRO_EV, CAR.KIA_NIRO_HEV_2021, CAR.SANTA_FE,
                         ...
                         CAR.SANTA_FE_PHEV_2022, CAR.KIA_STINGER_2022, CAR.KIA_K5_HEV_2020, CAR.ELANTRA_2022_NON_SCC,
...
def create_acc_commands(packer, enabled, accel, upper_jerk, lower_jerk, idx, lead_visible, set_speed, stopping, long_override, main_enabled,
  ...
  scc14_values = {
    ...
    "JerkLowerLimit": max(0.01, lower_jerk), # stock usually is 0.5 but sometimes uses higher values
